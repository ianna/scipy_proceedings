...
# big headline
ax.text(0, 9.4, HEADLINE, fontsize=46, fontweight="bold", color=GREEN, va="top")
ax.text(30, 8.55, "of Awkward's GPU kernels\nnow run as pure Python", fontsize=13.5,
...
ax.text(DONE + REMAIN/2, y+h/2 + 2.15, f"{REMAIN} CUDA C++", ha="center", va="bottom",
        color=DGREY, fontsize=11, fontweight="bold")
