...
ax.text(0,2.05,"Awkward today",fontsize=11,fontweight="bold",color=RED)
ax.text(100,2.05,"~260 tiny kernel launches  (CuPy + raw CUDA C++)",fontsize=10,color=RED,ha="right")
import math
...
ax.text(0,0.85,"with cuda.compute",fontsize=11,fontweight="bold",color=GREEN)
ax.text(100,0.85,"~30 fused kernels  ·  3x faster",fontsize=10,color=GREEN,ha="right")
...
for (s,e,lbl) in [(1,34,"select muons"),(39,66,"exactly 2 muons"),(73,95,"invariant mass")]:
    ...
    ax.text((s+e)/2,-0.22,lbl,ha="center",fontsize=8.5,color="#5a6b70")
